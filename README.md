...
3.  Inverse Model Learning: A neural network is trained to learn the inverse dynamics – mapping desired musical outputs (e.g., specific note characteristics from a melody's spectrogram) back to the required robot limb activations that produced those sounds during babbling.
